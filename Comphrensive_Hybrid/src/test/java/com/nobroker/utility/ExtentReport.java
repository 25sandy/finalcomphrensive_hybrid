...
public class ExtentReport {
	...
	public void enterPassLogWithSnap(String log) throws IOException {
		reportLog.pass(log,MediaEntityBuilder.createScreenCaptureFromPath(CaptureScreeshot.takeScreenshot()).build());
	}
	...
	public void enterFailLogWithSnap(String log) throws IOException {
		reportLog.fail(log,MediaEntityBuilder.createScreenCaptureFromPath(CaptureScreeshot.takeScreenshot()).build());
	}
